...
class Canister(TypedDict):
    canisterId: str
    tokenStandard: Literal['ext', 'dip721', 'ogy', 'icp-ledger']
    role: str
    name: str
    users: list[ObjectId]
...
class Guilds:
    ...
    def create_guild(self, guild_id: str, canister_id: str, token_standard: Literal['ext', 'dip721', 'ogy', 'icp-ledger'], role: str, name: str):
